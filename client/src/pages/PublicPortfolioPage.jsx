    ...
    <div className="space-y-24 bg-grid-mesh pb-20">
      ...
      >
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight">
            Biography &{" "}
            <span className="text-premium-gradient">Milestones</span>
          </h2>
      ...
      >
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight">
            Skills &{" "}
            <span className="text-premium-gradient">Proficiencies</span>
          </h2>
          <p className="text-xs text-slate-500">
      ...
      {certificates && certificates.length > 0 && (
        ...
        >
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight">
              Licenses &{" "}
              <span className="text-premium-gradient">Certifications</span>
            </h2>
            <p className="text-xs text-slate-500">
              ...
              >
                <div>
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] bg-slate-950 border border-slate-900 text-slate-500 px-2 py-0.5 rounded font-bold">
                        {p.difficulty}
                      </span>
                    </div>

                    <Link to={`/projects/${p._id}`}>
                      <h4 className="font-extrabold text-lg text-white leading-tight hover:text-blue-400 transition-colors cursor-pointer">
                        {p.title}
                      </h4>
                    </Link>
                ...
                <div className="p-6 pt-0 mt-4 border-t border-slate-900/80 flex items-center justify-between text-xs">
                  ...
                  <div className="flex gap-2">
                    <Link
                      to={`/projects/${p._id}`}
                      className="px-3.5 py-1.5 bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 rounded-lg font-bold text-[10px] flex items-center justify-center"
                    >
                      Showcase
                    </Link>
                    {p.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="p-2 bg-slate-950 border border-slate-900 rounded-lg text-slate-400 hover:text-white"
                      >
                    ...
                    {p.live && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="px-3.5 py-1.5 bg-blue-600/90 text-white rounded-lg font-bold hover:bg-blue-500 text-[10px]"
                      >
                        Demo
                      </a>
                    )}
      ...
      {gallery && gallery.length > 0 && (
        ...
        >
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <p className="text-xs text-slate-500">
              Moments from hackathons, technology speaking sessions, and
              achievements
            </p>
          </div>
      ...
      <section
        id="contact"
        className="container mx-auto px-6 max-w-3xl space-y-10"
      >
        <div className="text-center space-y-2">
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight">
            Get In <span className="text-premium-gradient">Touch</span>
          </h2>
          <p className="text-xs text-slate-500">
        ...
        >
          {contactStatus === "success" && (
            <div className="p-4 bg-emerald-950/40 text-emerald-400 border border-emerald-900 rounded-xl text-xs font-semibold">
              ✔ Message submitted successfully! Secure email confirmation alert
              has been logged in console.
            </div>
          )}
          {contactStatus === "error" && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-6">
          <div className="glass-panel p-6 max-w-md w-full rounded-3xl border border-slate-800 shadow-2xl space-y-6 animate-premium-float text-white relative">
            ...
            <div className="space-y-1.5 text-center">
              ...
              <h4 className="font-extrabold text-base text-white uppercase tracking-wide">
                Share Project
              </h4>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <span className="text-amber-400 group-hover:scale-110 transition-transform font-bold text-xs tracking-tighter bg-amber-950/80 border border-amber-900 h-5 w-5 rounded-full flex items-center justify-center">
                    N
                  </span>
                  <span className="text-[10px] text-slate-400 font-bold group-hover:text-white transition-colors">
                    Naukri.com
